...
while (year <= 2025):
    ...
    while (month <= 12):
        ...
        output_location = f'D:\Quanty\Queries\Comfandi\Complete List' #Specified file path for this specific dataset, would be changed based on the needs of the company. This version is hardcoded due to the fact that the location of the data I was downloading was constant.
        ...
        while (day <= numOfDays):
            ...
            for key, ticket in tickets_obj.items():
                ...
                ticket_flat = {
                    ...
                    "Fecha del Turno": datetime.utcfromtimestamp(ticket.get("issueDate", 0) / 1000).isoformat(), #Depriciated format has been left unchanged to preserve originality. The modern equvilant of this line would be: "Fecha del Turno": datetime.fromtimestamp(ticket.get("issueDate", 0) / 1000, tz=UTC)
...
playsound (completeSound) #Automatically plays a notification sound to alert me when the download had finished. This allowed me to focus on other aspects of the project while this worked in the background.
